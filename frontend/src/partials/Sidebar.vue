  ...
  <div>
    ...
    >
      ...
      <div class="flex justify-between mb-10 pr-3 sm:px-2">
        ...
        <!-- Logo -->
        <router-link class="block flex items-center space-x-1" to="/dashboard">
          <img class="mr-3 h-10 w-10" src="../assets/logo.png" />
          <p class="text-2xl text-red-600 uppercase font-extrabold">SAFFRON</p>
        </router-link>
      </div>
